            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fields = new ArrayList<Field>(_list0.size);
                Field _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Document struct) throws org.apache.thrift.TException {
      ...
      if (struct.fields != null) {
        oprot.writeFieldBegin(FIELDS_FIELD_DESC);
        {
          ...
          for (Field _iter3 : struct.fields)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetFields()) {
        {
          ...
          for (Field _iter4 : struct.fields)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fields = new ArrayList<Field>(_list5.size);
          Field _elem6;
